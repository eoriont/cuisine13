defmodule Cuisine13Web.Router do
  use Cuisine13Web, :router

  import Cuisine13Web.UserAuth

  pipeline :browser do
    plug :accepts, ["html"]
    plug :fetch_session
    plug :fetch_live_flash
    plug :put_root_layout, {Cuisine13Web.LayoutView, :root}
  ...
  if Mix.env() in [:dev, :test] do
    ...
    scope "/" do
      ...
      live_dashboard "/dashboard", metrics: Cuisine13Web.Telemetry
    end
  end
